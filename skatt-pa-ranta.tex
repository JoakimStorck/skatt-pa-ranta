...
Att naturresursräntan i dag tas ut svagt är ett politiskt val, inte en naturlag. Fastighetsskatten på vattenkraftverk sänktes 2017--2020, mineralersättningen är internationellt låg, och Norge tar samma slags ränta genom en \emph{grunnrenteskatt}. Den neutrala mekanismen är en ränteskatt som drar av normal avkastning och bara träffar överskottet, en konstruktion Schwerhoff, Edenhofer och Fleurbaey (2020) går igenom för just resursräntor. Eftersom basen är orörlig kan den tas hårdare utan att bromsa normala investeringar, till skillnad från en platt royalty som kan slå ut marginella fyndigheter.
...
Hur stort är då utrymmet på andra sidan? Svaret spänner över ett intervall, och det som skiljer ändarna är en enda parameter: markandelen av bebyggd fastighet. Intervallet är genomgående försiktigt räknat mot den internationella litteratur som skattat markens beskattningsbara kapacitet betydligt högre (Gaffney 2009; Dwyer 2003).
...
Dessa fem respektive sju procent är räntans fulla storlek, inte det belopp som tas ut i reformens första steg. Två frågor måste hållas isär: vad skatten beräknas på, och hur stor andel av räntan som tas ut. En löpande skatt som beräknas på markens \emph{marknadspris} urholkar sin egen bas, eftersom priset faller när skatten aviseras. Med skattesatsen $t$ och avkastningskravet $r$ blir priset $R/(r+t)$ och intäkten bara andelen $t/(t+r)$ av räntan $R$; en tvåprocentig skatt på marknadsvärdet fångar vid $r=4$ procent alltså en tredjedel av räntan, inte allt. Det danska utfallet med full kapitalisering (Høj och Jørgensen 2018) är just denna mekanism i praktiken. Skatten läggs därför på markens \emph{avkastningsvärde}, taxerat markvärde gånger avkastningskravet, vilket också är den bas Mirrlees Review förordar när den rekommenderar skatt på hyresvärdet framför kapitalvärdet. Då blir uttaget en bestämd andel av räntan oavsett vad priset gör. I det som följer tas hälften av räntan ut i steg ett, alltså \textbf{2,5 respektive 3,6 procent} av BNP. Den andra hälften är en potential för senare steg, inte en intäkt som räknas hem här.

Till detta kommer \textbf{övervinsterna}. Att mäta dem kräver en konstruktion, inte en uppslagning: statistiken redovisar bara det samlade driftsöverskottet, inte hur stor del som är normal avkastning och hur stor del som är ränta. Räntan får därför skattas som en residual: nettodriftsöverskottet minus en normal avkastning på kapitalstocken (avkastningskrav gånger kapitalstockens värde). Internationellt pekar sådana skattningar åt samma håll: Barkai (2020) finner för USA att den rena vinstens andel steg medan kapitalets andel föll, så att den växande vinsten till stor del inte är betalning för mer kapital utan ränta, knuten till patent, data och nätverkseffekter (jämför De Loecker, Eeckhout och Unger 2020 om stigande prispåslag). För svensk del bör två saker hållas i minnet: löneandelen har varit förhållandevis stabil sedan 1980-talet, så bilden av en skenande vinstandel passar sämre än i USA, där löneandelens fall är knutet till omfördelning mot ett fåtal superstjärneföretag (Autor m.fl.\ 2020); och exportmästarnas vinst är till stor del förtjänad avkastning som pressas av internationell konkurrens (se avsnittet om innovation). En residualskattning på svenska nationalräkenskaper (redovisad i bilagans räntekalkyl) visar tvärtom att den rena marknadsmaktsräntan i Sverige är liten, i storleksordningen 0--2,5 procent av BNP, eftersom en mycket stor del av bolagssektorns nettoöverskott motsvarar en normal avkastning på en mycket stor kapitalstock. Barkais amerikanska resultat beskriver alltså en riktning, inte en svensk nivå. Det betyder inte att den fångade basen är liten, utan att dess tyngdpunkt ligger i mark, lägesvärden och naturresursräntor snarare än i klassisk övervinst: en del av fastighetsbolagens överskott är lägesränta, som modellen ändå fångar men i markledet. Hur mycket ren övervinst som kan tas ut styrs inte av någon effektivitetsgräns, eftersom ren ränta i princip kan beskattas hårt utan att avskräcka någon investering, utan enbart av rörligheten; realistiskt handlar det om någon enstaka procent av BNP, och den rörliga delen kräver internationellt samarbete (Pillar Two).
...
I de illustrativa scenarierna räcker markvärden, naturresursräntor och den mindre posten fångbar övervinst och koncessionsränta till att sänka dagens arbetsskatt med ungefär en sjundedel i den försiktiga läsningen och knappt en femtedel i den generösa, vid det halva ränteuttag steg ett bygger på. Det är markvärdet, inte övervinsten, som avgör spannet. För Sverige är detta i första hand en mark- och lägesvärdesreform, kompletterad med naturresursräntor och mindre poster av koncessions- och övervinstränta; övervinstbeskattningen är principiellt viktig men empiriskt sekundär. Ordningsregeln är oberoende av exakt belopp: den första reformkronan går till lägre skatt på arbete, inte till avlastning av normal kapitalavkastning. Reformen är en sekvens: fånga ränta först, lätta arbete först, avlasta normal kapitalavkastning sist.
...
\hline
Arbete & 23,6 & 20,4 & 19,3 \\
Konsumtion (moms, punktskatter) & 10,6 & 10,6 & 10,6 \\
Kapital och bolag, nuvarande uttag & 6,2 & 6,2 & 6,2 \\
Mark-, läges- och naturresursvärden (halvt uttag) & 0,3 & 2,5 & 3,6 \\
Fångbar övervinst + koncessionsränta & -- & 1,0 & 1,0 \\
\hline
Summa (avrundat) & $\sim$40,7 & $\sim$40,7 & $\sim$40,7 \\
\hline
\end{tabular}
\caption{Reformutfall, intäktsneutralt, steg ett: arbete sänks först. Kapital- och bolagsskattebasen avlastas inte i detta steg; den ligger kvar medan nya ränteintäkter används för att sänka arbetsskatten. \newline Anm.: Posten \enquote{kapital och bolag} lämnas i huvudsak oförändrad i steg ett trots att den i dagens system fortfarande blandar normal avkastning och ränta. Det är ett sekvenseringsval, inte en principiell slutpunkt: arbetsskatten sänks först; uppdelningen mellan normal avkastning och ränta görs därefter, när budgetutrymme finns. Posten \enquote{fångbar övervinst och kvarvarande koncessionsränta} är satt till omkring 1 procent i båda läsningarna, eftersom svenska data visar att den är liten (se bilagans räntekalkyl och koncessionsavsnitt); det som skiljer den försiktiga från den generösa läsningen är markvärdet. Markraden avser ett halvt uttag av markräntan, beräknat på avkastningsvärdet; den fulla räntan (5,0 respektive 7,2 procent av BNP) är en potential för senare steg och räknas inte hem här.}
\label{tab:reformutfall}
\end{table}

I den försiktiga läsningen frigörs omkring 3,2 procent av BNP till lägre arbetsskatt. Arbetsbeskattningen faller då från omkring 23,6 till 20,4 procent av BNP, alltså med ungefär en sjundedel. I den generösa läsningen frigörs omkring 4,3 procent av BNP, vilket sänker arbetsbeskattningen till omkring 19,3 procent av BNP, knappt en femtedel lägre än dagens nivå. Reformens centrala numeriska resultat är därför inte att kapitalet lättas, utan att arbetsskatten faller med ungefär en sjundedel i den försiktiga läsningen och knappt en femtedel i den generösa. Ett fullt uttag av markräntan skulle fördubbla dessa tal, men till priset av ett dubbelt så stort prisgenomslag på marken, vilket är skälet att steg ett stannar vid hälften.
...
\hline
Kvalificerat arbete: utbudskil (inkl.\ moms) & $\sim$71\,\% & $\sim$64--68\,\% & $\sim$62--66\,\% \\
\quad substitutionsmarginal (exkl.\ moms) & $\sim$64\,\% & $\sim$57\,\% & $\sim$55\,\% \\
Automationskapitalets normalavkastning & $\sim$10--15\,\% & $\sim$10--15\,\% & $\sim$10--15\,\% \\
Kil människa $\leftrightarrow$ automation & $\sim$49--54 pp & $\sim$42--47 pp & $\sim$40--45 pp \\
\hline
\end{tabular}
...
Hur långt kan växlingen i princip drivas? Frågan behöver först göras precis, för \enquote{avskaffa skatten på arbete} betyder olika saker i de två kilarna. Utbudskilen kan inte avskaffas utan att den offentliga sektorn krymper: varje skatt som finansierar löntagarnas egen konsumtion sänker reallönen, och en växling från arbetsskatt till konsumtionsskatt lämnar den i stort sett oförändrad. Substitutionsmarginalen kan däremot i princip drivas mot noll, av samma skäl som bär tabell~\ref{tab:kilen}: konsumtionsskatten belastar slutprodukten lika oavsett produktionssätt och snedvrider därför inte valet mellan människa och maskin. Det långtgående målet är alltså inte noll skatt på arbete utan noll skillnad mellan arbete och automation i marginalen. Syftet är inte en mindre stat, utan att samma stat finansieras utan att måttstocken pekar mot maskinen.

Aritmetiskt ser den längre vägen ut så här. Fullt uttag av markräntan i stället för hälften ger ytterligare 2,5--3,6 procent av BNP. En enhetlig och breddad moms, i linje med Mirrlees Reviews rekommendation om få undantag och reducerade satser, kan ge i storleksordningen 3--5 procent, och varje sådan krona är neutral på substitutionsmarginalen. En arvs- och gåvoskatt träffar värde som mottagaren inte själv skapat och passar därmed modellens definition av fångat värde; internationellt ger den 0,2--0,7 procent av BNP. Planvinster vid ändrad markanvändning är offentligt skapad knapphet i ren form och hör till koncessionsledet. Den del av arbetsgivaravgiften som ger pensionsrätt är i marginalen ingen skatt, så en transparent förmånskoppling tar bort en bit av kilen definitionsmässigt, utan intäktsbortfall. Räknar man generöst, och lägger till miljö- och resursskatter som en tredje pelare med den egna motivering föregående stycke kräver, landar summan kring 15 procent av BNP. Det räcker inte till hela arbetsskatten på 23,6 procent, men det räcker till ungefär en halvering, och till en substitutionsmarginal kring 30--35 procent i stället för dagens 64. Det fullständiga avskaffandet av utbudskilen ligger utom räckhåll inom oförändrade utgifter; det fullständiga avskaffandet av substitutionssnedvridningen gör det inte.

Till detta kommer ett dynamiskt argument som väger tyngre ju mer av automationsscenariot som förverkligas. Om den kognitiva automationen blir så genomgripande som aktualitetsargumentet antar, krymper arbetsskattebasen av sig själv, samtidigt som värdet flyttar in i just de baser modellen pekar ut: plattforms- och dataräntor, bestående övervinster och lägesvärden där verksamheten koncentreras. Residualkalkylen i bilagan visar att den rena räntan är liten i Sverige i dag; Barkai (2020) och De Loecker, Eeckhout och Unger (2020) visar åt vilket håll den rör sig där automationen och plattformsekonomin kommit längre. Ett räntebaserat skattesystem skalar därmed med samma utveckling som urholkar det arbetsbaserade. Migrationen av skattebasen är i den meningen inte bara önskvärd utan på sikt framtvingad; frågan är om den sker ordnat och i förväg eller genom en fiskal kris i efterhand.

% =====================================================================
\section{Vad händer med markpriserna, och var i landet?}

En löpande skatt på markvärde sänker markpriset, eftersom köparen räknar in den framtida skatten och bjuder lägre. Eftersom skatten beräknas på avkastningsvärdet blir tumregeln enkel: markpriset faller ungefär med den andel av markräntan som tas ut. Ett halvt uttag halverar alltså markens värde, men \textbf{bara markens del}, inte huset. Är marken 45 procent av villans värde sjunker hela priset omkring 22 procent, och bara om skatten slår igenom fullt ut.

Detta är en \emph{engångssänkning} av priset, inte en löpande börda. Utspridd över en infasning på tjugo år blir den ungefär 1,3 procentenheter lägre prisökning per år, mindre än vad bostadspriser normalt stiger. Priserna \emph{bromsar} alltså, de faller inte. Antaget här är en nominell prisökning på omkring fyra procent per år före reformeffekten. En bostad värd 4 miljoner i dag blir efter tjugo år värd omkring 6,8 miljoner med reformen mot 8,8 utan den, alltså fortfarande en ökning med omkring sjuttio procent.
...
Antagande: en markskatt som drar in omkring 3 procent av BNP, alltså ett halvt uttag av markräntan i den centrala läsningen, växlad mot lägre skatt på arbete utan att statens samlade intäkter ändras. Siffrorna är illustrativa.
...
\begin{itemize}
\item \textbf{Tidsprofilen går inte ihop med behovet.} Behovet är trängande, men genomslaget tar decennier: markskatten kräver femton till tjugofem års infasning medan den kognitiva automationen slår igenom nu. Reformen hinner därför inte neutralisera den första vågen; dess uppgift på kort sikt är att inte förvärra snedvridningen och att sätta riktningen. En delvis kompensation är att övervinst-, koncessions- och naturresursleden inte kräver någon infasning, eftersom det inte finns någon kapitaliseringschock att sprida ut, och därför kan tas först i tiden, spegelvänt mot beloppsordningen.
...
Mark/natur 2,5 \% (försiktig, markandel 35 \%, halvt uttag) & Hämtad/ härledd & Markvärde ur fastighetstaxeringen (SCB): lantbruk 1\,386 mdkr (exakt: skog, jordbruk, tomtmark) plus 35 \% av bebyggt totalt taxeringsvärde 13\,194 mdkr, dividerat med 0,75 för marknadsvärde $\to$ markförmögenhet $\sim$8\,000 mdkr ($\sim$1,2 $\times$ BNP); kapitaliserad vid $r=$4 \% $\to$ full markränta 5,0 \% av BNP, varav hälften tas ut i steg ett $\to$ 2,5 \%. Posten omfattar mark- och lägesvärden samt marknadsprissatt naturresursränta, inte oprissatta naturvärden. \\
Mark/natur 3,6 \% (generös, markandel 55 \%, halvt uttag) & Hämtad/ härledd & Samma summering med markandel 55 \% för bebyggd fastighet $\to$ markförmögenhet $\sim$11\,500 mdkr ($\sim$1,8 $\times$ BNP); kapitaliserad vid $r=$4 \% $\to$ full markränta 7,2 \% av BNP, halvt uttag 3,6 \%. Central markandel 45 \% ger $\sim$1,52 $\times$ BNP, full ränta $\sim$6,1 \% och halvt uttag $\sim$3,0 \%. Källa: SCB, Fastighetstaxeringar 2023--2025. \\
...
Utbudskil 64--68 \% / 62--66 \% (reform) & Härledd & Samma formel med arbetsgivaravgift och marginalskatt sänkta motsvarande frigjort utrymme (3,2 resp.\ 4,3 \% av BNP). Intervallet speglar hur sänkningen fördelas mellan arbetsgivaravgift, kommunal och statlig skatt. \\
Substitutions\-marginal $\sim$64 \% (nu); 57/55 \% (reform) & Härledd & Samma formel med momsledet uteslutet ($t_c=0$), eftersom momsen belastar slutprodukten lika oavsett produktionssätt. Kil mot automationskapitalets normalavkastning (10--15 \%): $\sim$49--54 pp nu; 42--47 resp.\ 40--45 pp efter reform. \\
...
\textbf{Uttagsandelen 50 \%.} Ett rent designval, inte en empirisk osäkerhet, och det enda antagande vars effekt är exakt proportionell: dubbleras andelen dubbleras både markintäkten och prisgenomslaget. Vid fullt uttag blir markintäkten 5,0--7,2 procent av BNP och arbetsskatten 17,9--15,7 procent, men då faller markens värde med hela lägesräntan i stället för hälften. Steg ett stannar vid hälften för att prisgenomslaget ska rymmas inom en infasning och för att lämna utrymme kvar för senare steg.
...
Marginalkilen i tabell~\ref{tab:kilen} beräknas ur den formel som anges ovan: (kommunalskatt $+$ statlig skatt $+$ momseffekt på det som återstår $+$ arbetsgivaravgift) delat med (1 $+$ arbetsgivaravgift). Med kommunalskatt 32,37, statlig 20, momseffekt 20 och arbetsgivaravgift 31,42 procent ger utgångsläget cirka 71 procent, \emph{utbudskilen} som styr valet att arbeta eller inte. Utesluter man momsledet ($t_c=0$) ger samma formel cirka 64 procent; det är \emph{substitutionsmarginalen}, relevant för valet människa/maskin, eftersom momsen belastar slutprodukten lika oavsett produktionssätt. Reformkolumnerna blir då cirka 57 (försiktig) och 55 procent (generös), och kilen mot automationskapitalets normalavkastning (10--15 procent) cirka 49--54 pp i utgångsläget, 42--47 respektive 40--45 pp efter reform. Den del av arbetsgivaravgiften som är förmånsanknuten (bland annat allmän pension) är i marginalen ingen ren skatt, så kilen är en \emph{övre} gräns: den är som renast över intjänandetaken, där hela avgiften är skatt, vilket är just det spann av kvalificerade löner reformen framför allt riktar sig mot.

Reformkolumnerna erhålls genom att sänka arbetsskattens komponenter (arbetsgivaravgift, kommunal och statlig marginalskatt) i proportion till den andel av arbetsskatten som frigörs, ungefär en sjundedel i den försiktiga läsningen (3,2 av 23,6 procent av BNP) och knappt en femtedel i den generösa (4,3 av 23,6), medan momsen hålls oförändrad. En sänkning av komponenterna med 13,5 procent ger en utbudskil på cirka 66 procent; en sänkning med 18 procent ger cirka 64 procent. Intervallen $\sim$64--68 respektive $\sim$62--66 procent speglar hur sänkningen fördelas mellan arbetsgivaravgift (som påverkar både täljare och nämnare) och marginalskatt (som bara påverkar täljaren). Talen är illustrativa och avser storleksordning, inte en exakt fördelningsprofil.
...
Kapitaliserad vid avkastningskrav 4 procent ger det en årlig markränta på 5,0--7,2 procent av BNP (central 6,1), varav hälften tas ut i steg ett. Det är lägre än de två gånger BNP som ibland antas i debatten (vilket hade gett 9--13 procent) och lägre än den beskattningsbara kapacitet Gaffney (2009) och Dwyer (2003) räknar fram i andra länder. Det drar reformens räckvidd åt det försiktiga hållet: arbetsskatten faller i steg ett med en sjundedel till knappt en femtedel, inte upp mot hälften. Vid fullt uttag av samma bas skulle sänkningen bli en fjärdedel till en tredjedel.
